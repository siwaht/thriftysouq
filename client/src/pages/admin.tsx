...
export default function AdminPage() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-purple-50/50 via-white to-violet-50/30 p-4 sm:p-6 lg:p-8">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 space-y-4 sm:space-y-0">
          <div>
            ...
            <p className="text-gray-600">Manage your luxury product inventory</p>
          </div>
