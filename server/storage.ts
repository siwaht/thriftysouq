...
export interface IStorage {
  ...
  createOrder(order: InsertOrder, items: InsertOrderItem[]): Promise<{ order: Order; orderNumber: string }>;
...
export class MemStorage implements IStorage {
  ...
  async createOrder(order: InsertOrder, items: InsertOrderItem[]): Promise<{ order: Order; orderNumber: string }> {
